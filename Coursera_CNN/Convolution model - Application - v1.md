...
```
    ...
    <ipython-input-27-28bdc5e43f40> in <module>()
    ----> 1 _, _, parameters = model(X_train, Y_train, X_test, Y_test)
    

    <ipython-input-26-4eeba76ebb78> in model(X_train, Y_train, X_test, Y_test, learning_rate, num_epochs, minibatch_size, print_cost)
